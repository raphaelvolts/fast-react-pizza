...
//Warning: Cannot update a component (`CartOverview`) while rendering a different component (`Order`).
...
export default function Order() {
  ...
  //Warning: Cannot update a component (`CartOverview`) while rendering a different component (`Order`).
  /* const oldCart = useSelector(getCart);
  const dispatch = useDispatch();
  if (oldCart.length > 0) dispatch(clearCart()); */
  ...
  return (
    <div className="space-y-8 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h3 className="text-xl font-semibold">Order #{id} Status</h3>
